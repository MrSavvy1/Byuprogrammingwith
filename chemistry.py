...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
  """Compute and return the total molar mass of all the
    ...
    Return: the total molar mass of all the elements in  my
  ...
  for i in symbol_quantity_list:
    ...
    if i <= symbol_quantity_list[-1]:
    
      for j in periodic_table_dict:
        
        if j == i[SYMBOL_INDEX]:
          molar_mass += i[QUANTITY_INDEX] * periodic_table_dict[j][ATOMIC_MASS_INDEX]
  return molar_mass
...
def main ():
  print ("This program computes the molar mass of a compound.")
  print("Enter the compound formula")
  
  form = input()
  print ("Enter the mass")
  mass1 = float(input ())
  period = make_periodic_table()
  symbol_quantity_list = parse_formula(form, period)
  compute = compute_molar_mass(symbol_quantity_list, make_periodic_table())
  
  
  mole= mass1/compute
  #print (f"The molar mass of the compound is {mole}", )
  print (mole)
  print(compute)
